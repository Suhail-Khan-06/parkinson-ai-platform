        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-slate-300">
              ...
              Advanced multimodal analysis using voice biomarkers,
              spiral handwriting patterns, and DATScan medical imaging
              powered by deep learning and AI fusion models.
